...
This is the official challenge validator, vendored into the repo so the
documented check (`python validate_submission.py submission.csv`) is
self-contained and runs without the hackathon bundle present.
"""
